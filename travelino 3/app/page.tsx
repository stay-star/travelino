...
const EXAMPLE_PROMPTS = [
  "Is 500 LKR fair for a tuk-tuk to the beach?",
  "What should I do here this afternoon?",
  "Does this situation feel safe right now?",
...
export default function Home() {
  ...
  async function sendMessage(text: string) {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "assistant", text: data.answer || data.error || "No answer received." },
      ]);
    } catch {
      setMessages((prev) => [
        ...prev,
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-neutral-500 leading-tight">
              Unawatuna · your companion on the ground
            </p>
          </div>
        </div>
        <button
          ...
          <div className="mt-6 space-y-5">
            <div className="text-center px-4">
              <p className="text-neutral-300 text-sm">
                Ask me anything you run into out here — prices, safety, food,
                what to do next. I'll give you a straight answer, not a list.
              </p>
            </div>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-end sm:items-center justify-center z-20">
          <div className="bg-neutral-950 border border-neutral-800 rounded-t-2xl sm:rounded-2xl w-full max-w-md p-5 max-h-[85vh] overflow-y-auto">
            ...
            <p className="text-xs text-neutral-500 mb-4">
              Totally optional — it just helps me give you sharper answers.
            </p>
            ...
            <label className="block mb-3">
              <span className="text-xs text-neutral-400">Home country</span>
              <input
            ...
            <div className="block mb-4">
              <span className="text-xs text-neutral-400">Diet / Allergies</span>
